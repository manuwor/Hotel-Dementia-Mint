...
const Price = styled(Chip)`
  ...
  font-family: 'Copper-Bold' !important;
`;
                                            ...
                                            !wallet || !isActive ?
                                                <div className="grid-control">
                                                    <div className="item-control">
                                                        ...
                                                        <span className="text-price">{isActive && whitelistEnabled && (whitelistTokenBalance > 0) ? (whitelistPrice + " " + priceLabel) : (price + " " + priceLabel)}</span>
                                                    </div>
                                                    <div className="item-control">
                                                        <span className="text-public-sale">Total <br></br>Minted</span>
                                                        <span className="text-price">
                                                            {wallet && isActive ?
                                                                <span>{itemsRedeemed} / {itemsAvailable}</span>: null}
                                                        </span>
                                                    </div>
